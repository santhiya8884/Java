...
public class LinkedListPtac2_13_11_2021 {
	...
	public static void main(String[] args) {
		...
		list3.add(1, list4);
		System.out.println(list3);
		//LinkedList l5=list3.clone();
		System.out.println(list3.clone());
		//list3.clear();
		System.out.println(list3);
		//containselement
		System.out.println(list3.contains("Ram"));
		System.out.println(list2.contains("Ram"));
		//containsAll ollection
